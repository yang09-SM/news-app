...
- [x] PrefManager 已新增 6 个收藏 CRUD 方法 + KEY_FAVORITES 常量
- [x] news_detail_menu.xml 菜单文件已创建，包含收藏 MenuItem
...
## 功能 3：社交分享
- [x] news_detail_menu.xml 包含分享 MenuItem
...
## 功能 5：推送通知
- [x] AndroidManifest.xml 已添加 POST_NOTIFICATIONS 权限
